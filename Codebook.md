#Codebook for Samsung Galaxy S smartphone data
Peer Review Assignment for Getting/Cleaning Data on Coursera
...
Mean and std are marked in variable names as:
* mean(): Mean value
* std(): Standard deviation

The final values included in the tidy data set are the means the observations for for each subject and activity. 
